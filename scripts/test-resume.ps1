...
# Payment tests use temporary signing keys and mocked Alipay transport; no sandbox credentials required.
$mavenArgs = @('-Dtest=ResumeEvidenceTest,AlipayPaymentTest,AlipaySignatureTest')
